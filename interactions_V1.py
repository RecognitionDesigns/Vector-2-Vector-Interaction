...
#    robot1 = anki_vector.Robot('00703d7c')
#    robot2 = anki_vector.Robot('0050169f')
...
# Connect to the Robot
    ...
    print("Vector 1 activated!")
    robot1.behavior.say_text("Vector 1 activated!")
    print("Vector 2 rolling out!")
    robot2.behavior.say_text("Vector 2 rolling out!")
